...
export const galleryOrder = z.object({
  ...
  /* Every gallery piece is sold framed and matted. These strings are written straight
     into Airtable, so they must stay byte-identical with the viewer's FRAMES/MATS values. */
  frameColor: z.enum(["Brown", "Black", "Antique Gold"]),
